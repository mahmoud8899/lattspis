...
export default function LocationModal(props) {
    ...
    return <Fragment>
        ...
        >
            ...
            <TouchableOpacity style={Styles.FirstContainer} onPress={CloseALL}>
            ...
            <View style={Styles.LastContainer}>
                ...
                {showCity ?
                    ...
                    <Fragment>
                        <View>
                            <Text style={[FontsDefault.TitleFont,FontsDefault.BALCK]} >location</Text>
                        </View>
                        ...
                        <TouchableOpacity style={Styles.flexLocation} onPress={HandleCity}>
                            <View style={[Styles.route, Styles.left, Styles.notColor]}>
