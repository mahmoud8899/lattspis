...
export const AddAddresResducres = (
    ...
    switch (action.type) {
        ...
        case ActionTypes.REMOVE_ALL_ADDRESS:
          ...
          // this is not chek ...
        case ActionTypes.NOT_CHECK_ADDRESS: return {
            ...state,
            myAddressLocal: action.payload,
            loading: false,
        }
...
// find an old address 
export const FindAnOldAddressReducress = (
    state = {
        oldAddress: null,
        loading: false,
        error: null
    ...
    switch (action.type) {
        ...
        case ActionTypes.ADD_OLD_ADDRESS_LOADING:
            return {
                ...state,
                loading: true
            }

        case ActionTypes.ADD_OLD_ADDRESS_SUSSFULLY:
            return {
                ...state,
                oldAddress: action.payload,
                loading: false
            }

        // remove one address
        case ActionTypes.ADD_OLD_ADDRESS_FAIL:
            return {
                ...state,
                error: action.payload,
                loading: false,
